...
const _interpolation = "Selam bugünün kuru:" + " " + firstVariable + "." + " Yapacağınız bütün işlemlerde fatura almayı unutmayınız. " + "Faturalarda KDV oranı " + kdvOrani + "." + " Bol kazançlar dileriz"
